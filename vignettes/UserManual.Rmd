...
The default is to return the number of PCs by Perpendicular line with 30 PCs. The following codes take the 50 PCs of the sinlge-cell RNA-seq data in TSCAN package after preprocessing as an example.
```{r}
data(procdata)
